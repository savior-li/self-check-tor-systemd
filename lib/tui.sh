...
tui_header() {
 ...
 |__   __|  __ \   /\   |  \/  |                                          | |    
    | |  | |  | | /  \  | \  / | __ _ _ __   __ _  __ _  ___ _ __   ___  __| |    
    | |  | |  | |/ /\ \ | |\/| |/ _` | '_ \ / _` |/ _` |/ _ \ '_ \ / _ \/ _` |    
    | |  | |__| / ____ \| |  | | (_| | | | | (_| | (_| |  __/ | | |  __/ (_| |    
    |_|  |_____/_/    \_\_|  |_|\__,_|_| |_|\__,_|\__, |\___|_| |_|\___|\__,_|    
                                                   __/ |                          
                                                  |___/                           
ASCII_LOGO
    echo -e "${TUI_WHITE}                         Version ${SCRIPT_VERSION} - Tor Proxy Management System${TUI_RESET}"
    echo ""
}
